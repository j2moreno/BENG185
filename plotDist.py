...
'''
plt.plot(xs, density,label = 'positive_control')
plt.plot(xs2, density2, label='negative_control')
plt.plot(list(range(-100,800)), postArray, label = 'posterior')
plt.legend(loc = 'best')
